...
export const toolkitInterface_shouldCloseWindow = (toolkit: ToolkitInterface): boolean => native.toolkitInterface_shouldCloseWindow(toolkit);
export const toolkitInterface_poolEvents = (toolkit: ToolkitInterface): void => native.toolkitInterface_poolEvents(toolkit);
export const toolkitInterface_getExecutionTime = (toolkit: ToolkitInterface): number => native.toolkitInterface_getExecutionTime(toolkit);
export const toolkitInterface_getTotalAllocatedMemory = (toolkit: ToolkitInterface): number => native.toolkitInterface_getTotalAllocatedMemory(toolkit);
export const toolkitInterface_waitQueueIdle = (toolkit: ToolkitInterface): number => native.toolkitInterface_waitQueueIdle(toolkit);
export const toolkitInterface_waitDeviceIdle = (toolkit: ToolkitInterface): number => native.toolkitInterface_waitDeviceIdle(toolkit);